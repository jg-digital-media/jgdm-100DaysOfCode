            ...
            <?php if (isAuthenticated()) : $user = getAuthenticatedUser();  ?>
                <div class="media-left">
                    <div class="btn-group-vertical" role="group">
                        ...
                        <span class="glyphicon glyphicon-triangle-top<?php if(getUserVote($book['id'], $user['id']) == 1) echo ' orange'; ?>"></span></a>
                        ...
                        <span class="glyphicon glyphicon-triangle-bottom<?php if(getUserVote($book['id'], $user['id']) == -1) echo ' orange'; ?>"></span></a>
                    </div>
                </div>
            <?php endif; ?>    
