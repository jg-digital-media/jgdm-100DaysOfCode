...
+ **Notes**
  + Busy with lots of things today.  Presented my draft to a client. Reviewing what I need to learn about Custom Post Types in WordPress. Also caught up with some other projects in AJAX and JavaScript.
+ **Technologies Used** - HTML5, CSS, JavaScript, PHP

### **R2D77:** Tuesday 25th June 2019
+ **Notes**
  + Almost finished the design for my new WordPress theme for a client.  I'm really happy with what I've put together (Sticky Nav Bar and responsive grid clickable grid system)  Hope my client will be too.  :-)
...
+ **Notes**
  ...
  + The reason the review data wasn't showing, up by the way, was because I forgot to add the constructor for the Review class. Sometimes you need a break to see these things
+ **Technologies Used** - PHP, json

### **R2D60:** Tuesday 21st May 2019
+ **Notes** 
  + Tax and NI day today. So not much time for coding but I did dip into Sonic Pi a bit today. Slowly learning more and more as I go including how to define code blocks order the music. Learning curve goes on.  :)
+ **Technologies Used** - Sonic Pi

### **R2D59:** Monday 20th May 2019
+ **Notes**
...
+ **Notes** 
  + Gruelling but successful day today. Have 4 separate Slim Routes set up and a basic PHP view in place. Going to spend some time sprucing up the HTML and CSS before trying to stretch my Slim skills a bit more! 
+ **Technologies Used** - PHP
