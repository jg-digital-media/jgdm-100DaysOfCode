...
+ **Notes**
  + Per my previous blog, today I unveiled the latest (and hopefully longest-lasting iteration of my portfolio. You can read more about it in the blog.  This project was created using HTML, CSS, PHP, and JavaScript. 

  + **Technologies used** - HTML5, SASS, WordPress, PHP


### R6D56 Thursday 4 February 2021  

+ **Notes**

  + I've thoroughly enjoyed working on this portfolio and think it's done wonders for my WordPress skills. I had tweeted I wanted to unveil today. But, I'll use tomorrow to polish off a few last minor details to get it ready for the public to see.
...
+ **Notes**
  ...
  + A nice productive start to the new week with updates to my photography and a relatively painless building for my portfolio site.

  + **Technologies used** - HTML5, SASS, WordPress, PHP

### R6D52: Friday 29 January 2021  
...
+ **Notes**
  ...
  + A little bit of WordPress today and a lot more HTML/CSS with JSON as I worked on my update to my photography website.

  + **Technologies used** - HTML5, SASS, WordPress, PHP, JavaScript, SQL
  
### R6D47: Friday 22 January 2021  
...
+ **Notes**
  ...
  + The latest on my 100DaysOfCode Journey is in my blog.  https://blog.jonniegrieve.co.uk 
...
+ **Notes**
  ...
  + The blog is almost ready, barring some things I'm holding back for future enhancements. Some are bugs I', keeping out and I have questions to answer but it's a working blog.  Will be doing code cleanup and final checks before releasing before Christmas!  :-)      
