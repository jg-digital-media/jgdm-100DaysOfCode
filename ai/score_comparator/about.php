...
<body>
    ...
    <header>
        ...
        <div class="tagline">Based on Newcastle United <span>(v3)</span> <span id="back---home"><a href="index.php">Back to Homepage</a></span></div>
    ...
    <section class="section---about">
        ...
        <p>Data last updated: <strong>11-04-2025</strong></p>
