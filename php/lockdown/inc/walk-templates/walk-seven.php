<?php 
    ...
    $walk_homepage_seven ="../../img/walk_homepage/walk-dene-seven-helseden-route.jpg";
?>
...
<section class="walk-template">
    ...
    <article>
        ...
        <div class="template-content">
            ...
            <img src="<?php echo $walk_homepage_seven; ?>" class="walk-template-img" alt="" title="" />
