...
+ **Notes**
  + More content finalised for my upcoming website, did some work with Arrays of objects and learned some good things about Responsive Web Design. 
      
  + **Technologies used** - HTML5, CSS, SVG, JSON 


### R5D86: Thursday 15th October 2020
...
+ **Notes**
  + Smartened up the markup in my client project
      
  + **Technologies used** - HTML5, CSS, SVG, JSON 


### R5D84: Tuesday 13th October 2020

+ **Notes**
  + Worked on several websites today with some behind the scenes and social sharing updates. Also developed another static site into a PHP based design structure.
...
### R5D79: Tuesday 6th October 2020

+ **Notes**
  + More work today with html5 linking the pages together and started responsive design.  
      
  + **Technologies used** - HTML5, CSS, SVG, JSON 

### R5D78: Monday 5th October 2020
...
+ **Notes**
  +  Finish work for 3 repositories. 
...
+ **Notes**
  + Had a lot of fun with Laravel Resource files and with a lot of trial and error I have routes sucessfully retrieving API data. And I learned how to hide sensitive database specific data too.   
                
  + **Technologies used** - HTML5, CSS, Laravel, JavaScript

### R5D45: Wednesday 12 August 2020
...
+ **Notes**
  +  See yesterday! The basis of the functionality for the projects I'm working on is now complete. Now it's mostly about design, styles and testing. #autocleanse #photolibrary #photography #100DaysOfCode 
...
### R5D31: Thursday 23 July 2020

+ **Notes**
  +  Got my new digital camera, started the process of developing my new photography website locally and continued working on my Laravel Project which meant fixing artisan on my laptop. Busy one. :) 
...
+ **Notes**
  +  Was able to follow this tutorial for extra practice on JavaScript DOM Scripting. Prepped for more updatescoming later on my Photography Website
...
+ **Notes**
  +  Bit confused as to why nothing I'm trying is affecting toggle of a group of images. 
