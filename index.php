...
<body id="top">   
    ...
    <section>
        ...
        <ul>
            ...
            <li><strong><a href="javascript/list_makers" title="List Makers with JavaScript" target="_blank">javascript/list_makers</a></strong> - Links to List makers with JS</li>
