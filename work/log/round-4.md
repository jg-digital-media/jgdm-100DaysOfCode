...
## **Status:** Day 96 of 100. **Last Update:** 03 June 2020
___
...
+ **Notes**  
  +  A brief look into JS functions as a refresher
...
+ **Notes**  
  +  Uploaded updates to my photography website to show the very latest photos. Beyond that, getting back in touch with some of my other projects.
...
+ **Notes**  
  +  Almost there for unveiling. Going to start looking at behind the scenes stuff for SEO and link sharing next before finishing touches and code cleanup.
...
### R4D69:  Friday 24 April 2020
+ **Notes**  Started a new Express project. So far so good. I understand the concepts. This will be like others I've made but will utilise a REST API
...
### R4D61:  Monday 6 April 2020
+ **Notes**  Good to be in a position to be position to earn a bit of money this week.  Going back into some PHP and WordPress work to make some changes for a client. Knocked a few items off the to do list. We will be launching soon.  

+ **Technologies used** - HTML5, CSS, PHP

### R4D60:  Friday 3 April 2020
...
### R4D57:  Tuesday 31 March 2020
+ **Notes**  Photography website coming along nicely, working locally but upload will have to wait til tomorrow. Currently negotiating to do further website changes for a client to hopefully kick off new financial year!  :)
