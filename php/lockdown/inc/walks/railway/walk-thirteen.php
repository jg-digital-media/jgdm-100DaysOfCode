<!--<p> <?php echo "Walk 13";  ?> </p> -->

<article class="walk">

    <div>

        <h3><?php echo $trailTitleThirteen; ?></h3>
    ...
    <div>
        <img src = "img/walk_homepage/walk-thirteen.jpg" alt = "<?php echo $trailTitleThirteen; ?>" title="<?php echo $trailTitleThirteen; ?>" />

        <!-- opens modal -->
        <a href="#" class="walk-btn modal_btn" id="modal_btn_thirteen" title="Open Route">Open Route</a>
        
        <div id="modal-area-thirteen" class="modal">

            <div id="walk-modal-thirteen">
                ...
                <div class="modal-content">
                    ...
                    <div class="lightbox-slider">
                        ...
                        <a href="https://projects.jonniegrieve.co.uk/walks/img/walk-thirteen/IMG_20200506_141615.jpg" data-lightbox="walk-thirteen" data-title="This is a caption 3 route thirteen" class="lightbox-link"></a>
                        <a href="https://projects.jonniegrieve.co.uk/walks/img/walk-thirteen/IMG_20200506_141555.jpg" data-lightbox="walk-thirteen" data-title="This is a caption 3 route thirteen" class="lightbox-link"></a>
