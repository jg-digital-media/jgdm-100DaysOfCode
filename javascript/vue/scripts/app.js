...
const vue = new Vue({
    ...
    el: '#vue',
    data: {
        pageTitle: 'Vue.js Blog Page', //render with mustahce syntax
...
v-bind - for declarative rendering syntax  - Mustaches cannot be used inside HTML attributes. Instead, use a v-bind directive:v-if - loops and conditions
