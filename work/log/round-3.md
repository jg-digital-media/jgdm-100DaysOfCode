...
+ **Notes** - 
  +  Added a new section to Form Project over at https://projects.jonniegrieve.co.uk/form_project and made some minor updates to the PHP based website I've been working on, removing more of the dummy content. Almost there!  :)
...
+ **Notes** - 
  + Worked mostly in Sass and HTML5 today. Uploaded a landing page for an advertising campaign I want to use it for and worked on markup and styling for my PHP based project.
+ **Technologies used** - HTML5, SASS/CSS, PHP

### R3D70:  Tuesday 12th November 2019
+ **Notes** - 
  + Worked mostly in Sass and HTML5 today. But I spent most of my time working out a runtime bug in VueJS which in the end turned out to be misplaced method in a Vue Component! 
