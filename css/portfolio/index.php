...
Last Updated:   21st January 2022 - 09:41
Page:           index.php
--->
            ...
            <form action = "<?php echo htmlspecialchars("process.php"); ?>" method = "POST" id="hire-form" tabindex="0">
                ...
                <div class="form-layout">
                    ...
                    <div class="div-row-consent">
                        ...
                        <label for="confirm" tabindex="0" id="consent-label">This is the boring consent bit. :)</label>

                        
                        Please let me know you have read, understood and agree to the <a href="#" onClick="openWindow('./pages/gdpr.html', '550', '250')" title="Click this link to go to Jonnie Grieve Digital Media's data privacy policy" alt="Click this link to go to Jonnie Grieve Digital Media's data privacy policy">privacy policy <span role="required-field">*</span></a>.
                            <input type="checkbox" id="confirm" name="confirm" value="Confirmed Consent" 
                            oninvalid="this.setCustomValidity('Have you read, understood and agree to my privacy policy? This won\'t take you long to read :)')" placeholder="Click Consent" tabindex="0" />
                    </div>
