...
INSERT INTO bournemouth_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('AFC Bournemouth', 1, 'Chelsea', 3, 1),
    ('AFC Bournemouth', 0, 'Crystal Palace', 2, 1),
    ('AFC Bournemouth', 3, 'Everton', 0, 1),
    ('AFC Bournemouth', 2, 'Fulham', 1, 1),
    ('AFC Bournemouth', 1, 'Nottingham Forest', 1, 1),
    ('AFC Bournemouth', 1, 'Manchester City', 4, 1),
    ('AFC Bournemouth', 0, 'Manchester United', 1, 1),
    ('AFC Bournemouth', 4, 'Leeds United', 1, 1),
    ('AFC Bournemouth', 2, 'Leicester City', 1, 1),
    ('AFC Bournemouth', 1, 'Liverpool', 0, 1),
    ('AFC Bournemouth', 0, 'Southampton', 1, 1),
    ('AFC Bournemouth', 2, 'Tottenham Hotspur', 3, 1),
    ('AFC Bournemouth', 0, 'West Ham United', 4, 1),
...
INSERT INTO arsenal_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ('Arsenal', 3, 'AFC Bournemouth', 2, 1),
    ('Arsenal', 2, 'Aston Villa', 1, 1),
    ('Arsenal', 1, 'Brentford', 1, 1),
    ('Arsenal', 0, 'Brighton & Hove Albion', 3, 1),
...
INSERT INTO astonvilla_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Aston Villa', 1, 'Fulham', 0, 1),
    ('Aston Villa', 2, 'Nottingham Forest', 0, 1),
    ('Aston Villa', 1, 'Manchester City', 1, 1),
    ('Aston Villa', 3, 'Manchester United', 1, 1),
    ('Aston Villa', 2, 'Leeds United', 1, 1),
    ('Aston Villa', 2, 'Leicester City', 4, 1),
    ('Aston Villa', 1, 'Liverpool', 3, 1),
    ('Aston Villa', 1, 'Southampton', 0, 1),
    ('Aston Villa', 2, 'Tottenham Hotspur', 1, 1),
...
INSERT INTO brighton_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Brighton & Hove Albion', 3, 'Southampton', 1, 1),
    ('Brighton & Hove Albion', 0, 'Tottenham Hotspur', 1, 1),
    ('Brighton & Hove Albion', 4, 'West Ham United', 0, 1),
    ('Brighton & Hove Albion', 6, 'Wolverhampton Wanderers', 0, 1);
...
INSERT INTO chelsea_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Chelsea', 0, 'Aston Villa', 2, 1),
    ('Chelsea', 0, 'Brentford', 2, 1),
    ('Chelsea', 1, 'Brighton & Hove Albion', 2, 1),
    ('Chelsea', 1, 'Crystal Palace', 0, 1),
    ('Chelsea', 2, 'Everton', 2, 1),
    ('Chelsea', 0, 'Fulham', 0, 1),
    ('Chelsea', 2, 'Nottingham Forest', 2, 1),
...
INSERT INTO crystalpalace_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ('Crystal Palace', 2, 'AFC Bournemouth', 0, 1),
    ...
    ('Crystal Palace', 2, 'Leicester City', 1, 1),
    ('Crystal Palace', 0, 'Liverpool', 0, 1),
    ('Crystal Palace', 1, 'Southampton', 0, 1),
    ('Crystal Palace', 0, 'Tottenham Hotspur', 4, 1),
    ('Crystal Palace', 4, 'West Ham United', 3, 1),
...
INSERT INTO fulham_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Fulham', 2, 'Crystal Palace', 2, 1),
    ('Fulham', 0, 'Everton', 0, 1),
    ('Fulham', 2, 'Nottingham Forest', 0, 1),
    ('Fulham', 1, 'Manchester City', 2, 1),
    ('Fulham', 1, 'Manchester United', 2, 1),
    ('Fulham', 2, 'Leeds United', 1, 1),
    ('Fulham', 5, 'Leicester City', 3, 1),
    ('Fulham', 2, 'Liverpool', 2, 1),
    ('Fulham', 2, 'Southampton', 1, 1),
    ('Fulham', 0, 'Tottenham Hotspur', 1, 1),
    ('Fulham', 0, 'West Ham United', 1, 1),
...
INSERT INTO manchestercity_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Manchester City', 4, 'Arsenal', 1, 1),
    ('Manchester City', 3, 'Aston Villa', 1, 1),
    ...
    ('Manchester City', 2, 'Leeds United', 1, 1),
    ('Manchester City', 3, 'Leicester City', 1, 1),
    ('Manchester City', 4, 'Liverpool', 1, 1),
...
INSERT INTO manchesterunited_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Manchester United', 1, 'Brentford', 0, 1),
    ('Manchester United', 1, 'Brighton & Hove Albion', 2, 1),
    ('Manchester United', 4, 'Chelsea', 1, 1),
    ('Manchester United', 2, 'Crystal Palace', 1, 1),
    ('Manchester United', 2, 'Everton', 0, 1),
    ('Manchester United', 2, 'Fulham', 1, 1),
    ...
    ('Manchester United', 2, 'Wolverhampton Wanderers', 0, 1);   
...
INSERT INTO leeds_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Leeds United', 0, 'Brentford', 0, 1),
    ('Leeds United', 2, 'Brighton & Hove Albion', 2, 1),
    ('Leeds United', 3, 'Chelsea', 0, 1),
    ('Leeds United', 1, 'Crystal Palace', 5, 1),
    ...
    ('Leeds United', 0, 'Manchester United', 2, 1),
    ('Leeds United', 1, 'Leicester City', 1, 1),
    ('Leeds United', 1, 'Liverpool', 6, 1),
    ('Leeds United', 1, 'Southampton', 0, 1),
    ('Leeds United', 1, 'Tottenham Hotspur', 4, 1),
...
INSERT INTO leicester_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ('Leicester City', 0, 'AFC Bournemouth', 1, 1),
    ('Leicester City', 0, 'Arsenal', 1, 1),
    ...
    ('Leicester City', 0, 'Liverpool', 3, 1),
    ('Leicester City', 1, 'Southampton', 2, 1),
    ('Leicester City', 4, 'Tottenham Hotspur', 1, 1),
    ('Leicester City', 2, 'West Ham United', 1, 1),
    ('Leicester City', 2, 'Wolverhampton Wanderers', 1, 1);
...
INSERT INTO southampton_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ('Southampton', 0, 'AFC Bournemouth', 1, 1),
    ...
    ('Southampton', 0, 'Crystal Palace', 2, 1),
    ('Southampton', 1, 'Everton', 2, 1),
    ('Southampton', 0, 'Fulham', 2, 1),
    ('Southampton', 0, 'Nottingham Forest', 1, 1),
    ('Southampton', 1, 'Manchester City', 4, 1),
    ('Southampton', 0, 'Manchester United', 1, 1),
    ('Southampton', 2, 'Leeds United', 2, 1),
    ('Southampton', 1, 'Leicester City', 0, 1),
    ('Southampton', 4, 'Liverpool', 4, 1),
    ('Southampton', 3, 'Tottenham Hotspur', 3, 1),
...
INSERT INTO spurs_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Tottenham Hotspur', 2, 'West Ham United', 0, 1),
...
INSERT INTO westham_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('West Ham United', 2, 'Arsenal', 2, 1),
    ('West Ham United', 1, 'Aston Villa', 1, 1),
    ('West Ham United', 0, 'Brentford', 2, 1),
    ('West Ham United', 0, 'Brighton & Hove Albion', 2, 1),
    ('West Ham United', 1, 'Chelsea', 1, 1),
    ('West Ham United', 1, 'Crystal Palace', 2, 1),
    ('West Ham United', 2, 'Everton', 0, 1),
    ('West Ham United', 3, 'Fulham', 1, 1),
    ('West Ham United', 4, 'Nottingham Forest', 0, 1),
    ('West Ham United', 0, 'Manchester City', 2, 1),
    ('West Ham United', 1, 'Manchester United', 0, 1),
    ('West Ham United', 3, 'Leeds United', 1, 1),
    ('West Ham United', 0, 'Leicester City', 2, 1),
    ('West Ham United', 1, 'Liverpool', 2, 1),
    ('West Ham United', 1, 'Southampton', 0, 1),
...
INSERT INTO wolverhampton_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ('Wolverhampton Wanderers', 0, 'AFC Bournemouth', 1, 1),
    ('Wolverhampton Wanderers', 0, 'Arsenal', 2, 1),
    ('Wolverhampton Wanderers', 1, 'Aston Villa', 0, 1),
    ('Wolverhampton Wanderers', 2, 'Brentford', 0, 1),
    ('Wolverhampton Wanderers', 2, 'Brighton & Hove Albion', 3, 1),
    ('Wolverhampton Wanderers', 1, 'Chelsea', 0, 1),
    ...
    ('Wolverhampton Wanderers', 2, 'Leeds United', 4, 1),
    ('Wolverhampton Wanderers', 0, 'Leicester City', 4, 1),
    ('Wolverhampton Wanderers', 3, 'Liverpool', 0, 1),
    ('Wolverhampton Wanderers', 1, 'Southampton', 0, 1),
    ('Wolverhampton Wanderers', 1, 'Tottenham Hotspur', 0, 1),
