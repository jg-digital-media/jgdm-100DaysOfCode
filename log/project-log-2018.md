...
Populated the minor pages of new portfolio website with text replacing the dummy text. Another step forward in the new portfolio design.
...
Did some important updates to my new portfolio site today.  Will be serving some assets with Font-Awesome until I can find some other options. 

### **Day 92**: Friday February 1st 2019   

Just some stuff with Sass and HTML5 today.  Uploaded some images to serve as screenshot for my main portfolio page.  Looking forward to seeing how I can incorporate some Font Awesome icons for the rest. :)  
...
Continued to grapple with some things about using State in React.js.  But also learning some things about Git I'd not considered before. Could change the way I use Git Repos for the better. 
...
### **Day 87**: Wednesday January 23rd 2019
...
+ **Learning Goals:**
  + Start a refresher on using DOM Scripting with JavaScript via an example
  + Continue development of the portfolio website.
+ **Progress:**
  + The value of text inputs are printed to the browser console.  Next step, to add them as list items of a HTML list element.
+ **Thoughts:** 
  + This is about trying to finally gain more confidence in DOM Scripting and still building a workable example.
+ **Link to Work:** https://github.com/jg-digital-media/jgdm-100DaysOfCode 


### **Day 70**: Friday December 14th 2018

+ **Learning Goals:** More work on the portfolio design.
+ **Progress:** The website is taking shape, has a more consistent design and is responsive
...
+ **Progress:** Continued to build new pages for the portfolio site.
+ **Thoughts:** 
  + I haven't had a lot of time to work on the portfolio today but I've cleaned up the code a little bit, added some images with a placeholder in them and a background interior image.  
  
  + I'm envisioning a background image that covers the viewport with solid backgrounds scrolling around it but this effect is not in place yet.
+ **Link to Work:** https://github.com/jg-digital-media/jgdm-100DaysOfCode

### **Day 67**: Tuesday 11th December 2018

+ **Progress:**
 + Continued to build new pages for the portfolio site.  Introduces video and images elements and now utilises Flexbox twice.
+ **Link to Work:** https://github.com/jg-digital-media/jgdm-100DaysOfCode
...
Haven't left myself a lot of time to report but I did manage to get some good time in with the filter iteration method in JavaScript which was useful. Check  ```iteration.js``` 
...
+ **Progress:** Finished the React Scoreboard App  (yay :O) )
+ **Thoughts:** 

  + Feel like I've demystified what the deal is with PropTypes for the first time and how to use them.
  
  + Added the high score feature but I have to admit, I couldn't do that on my own.  I can build components in React, and I can learn to trigger events in the React way - The nuts and bolts but the functionality behind those events needs more work.

  + Think I've made significant steps forward though. 
+ **Link to Work:** https://github.com/jg-digital-media/jgdm-100DaysOfCode
...
+ **Thoughts:**
  ...
  + Great to learn about Controlled Components in React. About how inputs are stateful elements and need to be assigned a Handler in order to work.
