...
INSERT INTO base_scores_home (home_team, away_team, home_score, away_score, played) VALUES
    ...
    ('Leicester City', 'Newcastle United', 1, 2, 1),
    ('Liverpool', 'Newcastle United', 2, 0, 1),
    ('Manchester City', 'Newcastle United', 3, 1, 1),        
    ('Manchester United', 'Newcastle United', 4, 1, 1),
    ('Stoke City', 'Newcastle United', 0, 1, 1),
...
INSERT INTO bournemouth_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('AFC Bournemouth', 0, 'Manchester United', 2, 1),
    ('AFC Bournemouth', 2, 'Stoke City', 1, 1),
    ('AFC Bournemouth', 1, 'Southampton', 1, 1),
    ('AFC Bournemouth', 1, 'Swansea City', 0, 1),
    ('AFC Bournemouth', 1, 'Tottenham Hotspur', 4, 1),
    ('AFC Bournemouth', 0, 'Watford', 2, 1),
    ('AFC Bournemouth', 2, 'West Bromwich Albion', 1, 1),
    ('AFC Bournemouth', 3, 'West Ham United', 3, 1);
...
INSERT INTO arsenal_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Arsenal', 5, 'Burnley', 0, 1),
    ('Arsenal', 2, 'Chelsea', 2, 1),
    ('Arsenal', 4, 'Crystal Palace', 1, 1),
    ('Arsenal', 5, 'Everton', 1, 1),
...
INSERT INTO chelsea_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Chelsea', 1, 'Huddersfield Town', 1, 1),
    ('Chelsea', 0, 'Leicester City', 0, 1),
    ('Chelsea', 1, 'Liverpool', 0, 1),
    ('Chelsea', 0, 'Manchester City', 1, 1),
    ('Chelsea', 1, 'Manchester United', 0, 1),
    ('Chelsea', 5, 'Stoke City', 0, 1),
    ('Chelsea', 1, 'Southampton', 0, 1),
    ('Chelsea', 1, 'Swansea City', 0, 1),
    ('Chelsea', 1, 'Tottenham Hotspur', 3, 1),
    ('Chelsea', 4, 'Watford', 2, 1),
    ('Chelsea', 3, 'West Bromwich Albion', 0, 1),
    ('Chelsea', 1, 'West Ham United', 1, 1);
...
INSERT INTO crystalpalace_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Crystal Palace', 2, 'Arsenal', 3, 1),
    ('Crystal Palace', 3, 'Brighton & Hove Albion', 2, 1),
    ('Crystal Palace', 1, 'Burnley', 0, 1),
    ('Crystal Palace', 2, 'Chelsea', 1, 1),
    ('Crystal Palace', 2, 'Everton', 2, 1),
    ('Crystal Palace', 0, 'Huddersfield Town', 3, 1),
    ('Crystal Palace', 5, 'Leicester City', 0, 1),
    ('Crystal Palace', 1, 'Liverpool', 2, 1),
    ('Crystal Palace', 0, 'Manchester City', 0, 1),
    ('Crystal Palace', 2, 'Manchester United', 3, 1),
...
INSERT INTO everton_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Everton', 1, 'West Bromwich Albion', 1, 1),
...
INSERT INTO huddersfield_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ('Huddersfield Town', 4, 'AFC Bournemouth', 1, 1),
    ('Huddersfield Town', 0, 'Arsenal', 1, 1),
    ('Huddersfield Town', 2, 'Brighton & Hove Albion', 0, 1),
    ('Huddersfield Town', 0, 'Burnley', 0, 1),
    ('Huddersfield Town', 1, 'Chelsea', 3, 1),
    ('Huddersfield Town', 0, 'Crystal Palace', 2, 1),
    ('Huddersfield Town', 0, 'Everton', 2, 1),
    ('Huddersfield Town', 1, 'Leicester City', 1, 1),
    ('Huddersfield Town', 0, 'Liverpool', 3, 1),
    ('Huddersfield Town', 1, 'Manchester City', 2, 1),
    ('Huddersfield Town', 2, 'Manchester United', 1, 1),
    ('Huddersfield Town', 1, 'Stoke City', 1, 1),
    ('Huddersfield Town', 0, 'Southampton', 0, 1),
    ('Huddersfield Town', 0, 'Swansea City', 0, 1),
    ('Huddersfield Town', 0, 'Tottenham Hotspur', 4, 1),
    ('Huddersfield Town', 1, 'Watford', 0, 1),
    ('Huddersfield Town', 1, 'West Bromwich Albion', 0, 1),
    ('Huddersfield Town', 1, 'West Ham United', 4, 1);
  
INSERT INTO leicester_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ('Leicester City', 1, 'AFC Bournemouth', 1, 1),
    ('Leicester City', 3, 'Arsenal', 1, 1),
...
INSERT INTO liverpool_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Liverpool', 4, 'Brighton & Hove Albion', 0, 1),
    ...
    ('Liverpool', 4, 'Manchester City', 3, 1),
    ('Liverpool', 0, 'Manchester United', 0, 1),
    ('Liverpool', 0, 'Stoke City', 0, 1),
    ('Liverpool', 3, 'Southampton', 0, 1),
    ('Liverpool', 5, 'Swansea City', 0, 1),
    ('Liverpool', 2, 'Tottenham Hotspur', 2, 1),
    ('Liverpool', 5, 'Watford', 0, 1),
    ('Liverpool', 0, 'West Bromwich Albion', 0, 1),
    ('Liverpool', 4, 'West Ham United', 1, 1);  
...
INSERT INTO manchestercity_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Manchester City', 0, 'Huddersfield Town', 0, 1),
    ('Manchester City', 5, 'Leicester City', 1, 1),
    ('Manchester City', 5, 'Liverpool', 0, 1),
    ('Manchester City', 2, 'Manchester United', 3, 1),
    ('Manchester City', 7, 'Stoke City', 2, 1),
    ('Manchester City', 2, 'Southampton', 1, 1),
    ('Manchester City', 5, 'Swansea City', 0, 1),
...
INSERT INTO manchesterunited_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Manchester United', 2, 'Arsenal', 1, 1),
    ...
    ('Manchester United', 2, 'Huddersfield Town', 0, 1),
    ...
    ('Manchester United', 0, 'Southampton', 0, 1),
    ('Manchester United', 2, 'Swansea City', 0, 1),
...
INSERT INTO stokecity_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Stoke City', 1, 'Brighton & Hove Albion', 1, 1),
    ('Stoke City', 1, 'Burnley', 1, 1),
    ('Stoke City', 0, 'Chelsea', 4, 1),
    ('Stoke City', 1, 'Crystal Palace', 2, 1),
    ('Stoke City', 1, 'Everton', 2, 1),
    ('Stoke City', 2, 'Huddersfield Town', 0, 1),
    ('Stoke City', 2, 'Leicester City', 2, 1),
    ('Stoke City', 0, 'Liverpool', 3, 1),
    ('Stoke City', 0, 'Manchester City', 2, 1),
    ('Stoke City', 2, 'Manchester United', 2, 1),
    ('Stoke City', 2, 'Southampton', 1, 1),
    ('Stoke City', 2, 'Swansea City', 1, 1),
    ('Stoke City', 1, 'Tottenham Hotspur', 2, 1),
    ('Stoke City', 0, 'Watford', 0, 1),
...
INSERT INTO southampton_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ('Southampton', 2, 'AFC Bournemouth', 1, 1),
    ('Southampton', 1, 'Arsenal', 1, 1),
    ('Southampton', 1, 'Brighton & Hove Albion', 1, 1),
    ('Southampton', 0, 'Burnley', 1, 1),
    ('Southampton', 2, 'Chelsea', 3, 1),
    ('Southampton', 1, 'Crystal Palace', 2, 1),
...
INSERT INTO watford_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Watford', 2, 'Southampton', 2, 1),
    ('Watford', 1, 'Swansea City', 2, 1),
    ('Watford', 1, 'Tottenham Hotspur', 1, 1),
    ('Watford', 1, 'West Bromwich Albion', 0, 1),
...
INSERT INTO westbrom_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('West Bromwich Albion', 1, 'Arsenal', 1, 1),
    ('West Bromwich Albion', 2, 'Brighton & Hove Albion', 0, 1),
    ('West Bromwich Albion', 1, 'Burnley', 2, 1),
    ('West Bromwich Albion', 0, 'Chelsea', 4, 1),
    ('West Bromwich Albion', 0, 'Crystal Palace', 0, 1),
    ('West Bromwich Albion', 0, 'Everton', 0, 1),
    ('West Bromwich Albion', 1, 'Huddersfield Town', 2, 1),
    ('West Bromwich Albion', 1, 'Leicester City', 4, 1),
    ('West Bromwich Albion', 2, 'Liverpool', 2, 1),
    ...
    ('West Bromwich Albion', 2, 'Southampton', 3, 1),
    ('West Bromwich Albion', 1, 'Swansea City', 1, 1),
    ('West Bromwich Albion', 1, 'Tottenham Hotspur', 0, 1),
