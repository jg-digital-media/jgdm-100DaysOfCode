...
INSERT INTO base_scores_away (home_team, away_team, home_score, away_score, played) VALUES
    ...
    ('Newcastle United', 'Chelsea', 4, 1, 1),
...
INSERT INTO bournemouth_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('AFC Bournemouth', 3, 'Brighton & Hove Albion', 0, 1),
    ('AFC Bournemouth', 2, 'Burnley', 1, 1),
    ('AFC Bournemouth', 0, 'Chelsea', 0, 1),
    ('AFC Bournemouth', 1, 'Crystal Palace', 0, 1),
    ...
    ('AFC Bournemouth', 2, 'Manchester United', 2, 1),
    ('AFC Bournemouth', 1, 'Nottingham Forest', 1, 1),
    ('AFC Bournemouth', 2, 'Sheffield United', 2, 1),
...
INSERT INTO brentford_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Brentford', 0, 'Brighton & Hove Albion', 0, 1),
    ('Brentford', 3, 'Burnley', 0, 1),
    ('Brentford', 2, 'Chelsea', 2, 1),
    ('Brentford', 1, 'Crystal Palace', 1, 1),
    ('Brentford', 1, 'Everton', 3, 1),
    ('Brentford', 0, 'Fulham', 0, 1),
    ('Brentford', 1, 'Liverpool', 4, 1),
    ('Brentford', 3, 'Luton Town', 1, 1),
    ('Brentford', 1, 'Manchester City', 3, 1),
    ('Brentford', 1, 'Manchester United', 1, 1),
    ('Brentford', 3, 'Nottingham Forest', 2, 1),
    ('Brentford', 2, 'Sheffield United', 0, 1),
...
INSERT INTO brighton_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Brighton & Hove Albion', 0, 'Arsenal', 3, 1),
    ('Brighton & Hove Albion', 1, 'Aston Villa', 0, 1),
    ('Brighton & Hove Albion', 2, 'Brentford', 1, 1),
    ('Brighton & Hove Albion', 1, 'Burnley', 1, 1),
    ('Brighton & Hove Albion', 1, 'Chelsea', 2, 1),
    ('Brighton & Hove Albion', 4, 'Crystal Palace', 1, 1),
    ...
    ('Brighton & Hove Albion', 0, 'Manchester City', 4, 1),
    ('Brighton & Hove Albion', 0, 'Manchester United', 2, 1),
    ('Brighton & Hove Albion', 1, 'Nottingham Forest', 0, 1),
...
INSERT INTO everton_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Everton', 2, 'Liverpool', 0, 1),
    ('Everton', 1, 'Luton Town', 2, 1),
    ('Everton', 1, 'Manchester City', 3, 1),
    ('Everton', 0, 'Manchester United', 3, 1),
    ('Everton', 2, 'Nottingham Forest', 0, 1),
    ('Everton', 1, 'Sheffield United', 0, 1),
...
INSERT INTO fulham_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ('Fulham', 3, 'AFC Bournemouth', 1, 1),
    ('Fulham', 2, 'Arsenal', 1, 1),
    ('Fulham', 1, 'Aston Villa', 2, 1),
    ('Fulham', 0, 'Brentford', 3, 1),
    ('Fulham', 3, 'Brighton & Hove Albion', 0, 1),
    ('Fulham', 0, 'Burnley', 2, 1),
    ('Fulham', 0, 'Chelsea', 2, 1),
    ('Fulham', 1, 'Crystal Palace', 1, 1),
    ('Fulham', 0, 'Everton', 0, 1),
    ('Fulham', 1, 'Liverpool', 3, 1),
    ('Fulham', 1, 'Luton Town', 0, 1),
    ('Fulham', 0, 'Manchester City', 4, 1),
...
INSERT INTO luton_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ('Luton Town', 2, 'AFC Bournemouth', 1, 1),
    ('Luton Town', 3, 'Arsenal', 4, 1),
    ('Luton Town', 2, 'Aston Villa', 3, 1),
    ('Luton Town', 1, 'Brentford', 5, 1),
    ('Luton Town', 4, 'Brighton & Hove Albion', 0, 1),
    ('Luton Town', 1, 'Burnley', 2, 1),
    ('Luton Town', 2, 'Chelsea', 3, 1),
    ('Luton Town', 2, 'Crystal Palace', 1, 1),
    ('Luton Town', 1, 'Everton', 1, 1),
    ('Luton Town', 2, 'Fulham', 4, 1),
    ('Luton Town', 1, 'Liverpool', 1, 1),
    ('Luton Town', 1, 'Manchester City', 2, 1),
    ('Luton Town', 1, 'Manchester United', 2, 1),
    ('Luton Town', 1, 'Nottingham Forest', 1, 1),
    ('Luton Town', 1, 'Sheffield United', 3, 1),
...
INSERT INTO manchestercity_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Manchester City', 0, 'Arsenal', 0, 1),
    ('Manchester City', 4, 'Aston Villa', 1, 1),
    ...
    ('Manchester City', 5, 'Luton Town', 1, 1),
    ...
    ('Manchester City', 3, 'West Ham United', 1, 1),
    ('Manchester City', 5, 'Wolverhampton Wanderers', 1, 1);  
...
INSERT INTO manchesterunited_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Manchester United', 4, 'Sheffield United', 2, 1),
    ('Manchester United', 2, 'Tottenham Hotspur', 2, 1),
    ('Manchester United', 3, 'West Ham United', 0, 1),
...
INSERT INTO nottinghamforest_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Nottingham Forest', 2, 'Chelsea', 3, 1),
    ('Nottingham Forest', 1, 'Crystal Palace', 1, 1),
    ('Nottingham Forest', 0, 'Everton', 1, 1),
    ('Nottingham Forest', 3, 'Fulham', 1, 1),
    ('Nottingham Forest', 0, 'Liverpool', 1, 1),
    ...
    ('Nottingham Forest', 2, 'West Ham United', 0, 1),
    ('Nottingham Forest', 2, 'Wolverhampton Wanderers', 2, 1);
...
INSERT INTO sheffieldunited_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Sheffield United', 0, 'Arsenal', 6, 1),
    ('Sheffield United', 0, 'Aston Villa', 5, 1),
    ('Sheffield United', 1, 'Brentford', 0, 1),
    ('Sheffield United', 0, 'Brighton & Hove Albion', 5, 1),
    ('Sheffield United', 1, 'Burnley', 4, 1),
    ('Sheffield United', 2, 'Chelsea', 2, 1),
    ('Sheffield United', 0, 'Crystal Palace', 1, 1),
    ('Sheffield United', 2, 'Everton', 2, 1),
    ('Sheffield United', 3, 'Fulham', 3, 1),
    ...
    ('Sheffield United', 1, 'Nottingham Forest', 3, 1),
    ('Sheffield United', 0, 'Tottenham Hotspur', 3, 1),
...
INSERT INTO spurs_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Tottenham Hotspur', 2, 'Arsenal', 3, 1),
    ...
    ('Tottenham Hotspur', 3, 'Crystal Palace', 1, 1),
    ('Tottenham Hotspur', 2, 'Everton', 1, 1),
    ('Tottenham Hotspur', 2, 'Fulham', 0, 1),
    ('Tottenham Hotspur', 2, 'Liverpool', 1, 1),
    ('Tottenham Hotspur', 2, 'Luton Town', 1, 1),
    ('Tottenham Hotspur', 0, 'Manchester City', 2, 1),
...
INSERT INTO westham_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('West Ham United', 0, 'Arsenal', 6, 1),
    ('West Ham United', 1, 'Aston Villa', 1, 1),
    ('West Ham United', 4, 'Brentford', 2, 1),
    ('West Ham United', 0, 'Brighton & Hove Albion', 0, 1),
    ('West Ham United', 2, 'Burnley', 2, 1),
    ('West Ham United', 3, 'Chelsea', 1, 1),
    ('West Ham United', 1, 'Crystal Palace', 1, 1),
    ('West Ham United', 0, 'Everton', 1, 1),
    ('West Ham United', 0, 'Fulham', 2, 1),
    ('West Ham United', 2, 'Liverpool', 2, 1),
    ('West Ham United', 3, 'Luton Town', 1, 1),
...
INSERT INTO wolverhampton_home_matches (home_team, home_score, away_team, away_score, played) VALUES
    ...
    ('Wolverhampton Wanderers', 1, 'Crystal Palace', 3, 1),
    ('Wolverhampton Wanderers', 3, 'Everton', 0, 1),
    ('Wolverhampton Wanderers', 2, 'Fulham', 1, 1),
    ('Wolverhampton Wanderers', 1, 'Liverpool', 3, 1),
    ('Wolverhampton Wanderers', 2, 'Luton Town', 1, 1),
    ...
    ('Wolverhampton Wanderers', 1, 'West Ham United', 2, 1);
