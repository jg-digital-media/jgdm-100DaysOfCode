...
<body>
    ...
    <nav class="main-nav">
        <ol>
            <li><a href="index.html" title="Click here to go back to the top" tabindex="5">Home</a></li>
            <li><a href="#about-jgdm" title="Click here to jump to the About section" tabindex="6" >About</a></li>
            <li><a href="#services" title="Click here to jump to the Services section" tabindex="7" >Services</a></li>
            <li><a href="#hire-me" title="Click here to go jump to the hire me section" tabindex="8" >Hire Me</a></li>
            <li><a href="#dyspraxia" title="Click here to jump to the Dyspraxia section" tabindex="9" >Dyspraxia</a></li>
        </ol>
    </nav>

    <main class="main-content">

        <article id="intro" tabindex="10" >
        ...
        <article id="about-jgdm" tabindex="11" >  
        ...
        <article id="featured" tabindex="12" >

            <h2>Featured Projects of the Day!</h2>  

            <div class="show-featured">

                <a href="https://projects.jonniegrieve.co.uk/walks" target="blank"><img src="img/featured/castlewalks.png" class="site-images" alt="Go to Castle Walk website" title="Go to Castle Walk website" tabindex="13" /></a>                    
    
                <a href="https://projects.jonniegrieve.co.uk/" target="blank"><img src="img/featured/sub-projects.png" class="site-images" alt="Projects Subdomain website for Jonnie Grieve Digital Media" title="Projects Subdomain website for Jonnie Grieve Digital Media" tabindex="14" /></a><br />

                <a href="https://android.jonniegrieve.co.uk/" target="blank"><img src="img/featured/sub-android.png" class="site-images" alt="Code repository and Android Project Showcase website" title="Code repository and Android Project Showcase website" tabindex="15" /></a>
        ...
        <article id="about">
            ...
            <div class="about-box" tabindex="17" >
                <h3>My Work</h3>
            ...
            <div class="about-box" tabindex="19" >
                <h3>Testimonials</h3>
            ...
            <div class="about-box" tabindex="18" >
                <h3>Blog</h3>
        ...
        <article id="video" tabindex="20" >
            ...
            <video controls >
                <source src="assets/video.mp4" type="video/mp4" id="play-video" tabindex="21" >
            </video>

            <p class="button" tabindex="22" >Our Prices Really Do Take Some Beating!</p>

        </article>

        <article id="services" tabindex="23" >

            <h2>Services</h2>

            <div class="main-services" tabindex="24" >
            ...
            <div class="main-services" tabindex="25" >
            ...
            <div class="main-services" tabindex="26" >
            ...
            <div class="main-services" tabindex="27" >
            ...
            <div class="main-services" tabindex="28" >
            ...
            <div class="main-services" tabindex="29" >
            ...
            <div class="elsewhere" tabindex="30" >
            ...
            <div class="elsewhere" tabindex="31" >
            ...
            <div class="elsewhere" tabindex="32" >
            ...
            <div class="elsewhere" tabindex="33" >
            ...
            <div class="elsewhere" tabindex="34" >
            ...
            <div class="elsewhere" tabindex="35" >
        ...
        <article id="hire-me" tabindex="36" >
            ...
            <aside>
                ...
                <div class="hire-me-content" tabindex="37" >
                ...
                <div class="hire-me-content" tabindex="38" >
                ...
                <div class="hire-me-content" tabindex="39" >
            ...
            <form action = "thank-you.php" method = "POST" id="hire-form" tabindex="40">
                ...
                <div class="form-layout">
                    ...
                    <div class="div-row">
                        ...
                        <div class="col-one">
                            <label for="name" tabindex="41" >Your Name: <span>*</span> </label>
                        </div>

                        <div class="col-two">
                            <input type="text" id="name" name="name" required  
                            oninvalid="this.setCustomValidity('Please Enter Your Name!  :-)')" oninput="this.setCustomValidity('')" placeholder="Enter your name..." tabindex="42"  />
                        </div>
                    ...
                    <div class="div-row">
                        ...
                        <div class="col-one">
                            <label for="email" tabindex="43" >Your Email: <span>*</span> </label>
                        </div>

                        <div class="col-two">
                            <input type="email" id="email" name="email" required oninvalid="this.setCustomValidity('Please enter a valid email :-)')" oninput="this.setCustomValidity('')" placeholder="Enter your email..." tabindex="44"  />
                        </div>
                    ...
                    <div class="div-row">
                        ...
                        <div class="col-one">
                            <label for="your-url" tabindex="45" >Your URL: </label>
                        </div>

                        <div class="col-two">
                            <input type="text" id="your-url" name="your-url" placeholder="Any website you'd like me to look at..." tabindex="46"  />
                        </div>
                    ...
                    <div class="div-row">
                        ...
                        <div class="col-one">
                            <label for="subject" tabindex="47" >Your Subject: <span>*</span> </label>
                        </div>

                        <div class="col-two">
        
                            <input type="text" id="subject" name="subject" required oninvalid="this.setCustomValidity('Please enter a subject for your message')" oninput="this.setCustomValidity('')" placeholder="Service or help you require..." tabindex="48"  />
                    ...
                    <div class="div-row">
                        ...
                        <div class="col-one">
                            <label for="message" tabindex="49" >Your Message: <span>*</span> </label>
                        </div>

                        <div class="col-two">
        
                            <textarea id="message" name="message" required oninvalid="this.setCustomValidity('Enter a message!')"  oninput="this.setCustomValidity('')" placeholder="How can I help?" tabindex="50" ></textarea>
                    ...
                    <div class="div-row">
                        ...
                        <div class="col-one">
                            <label for="confirm" tabindex="51" >The boring consent bit. :) <span>*</span> </label>
                        </div>
                        ...
                        <div class="col-two">Please let me know you have read and agree with my <a href="javascript:" class="text2" onMouseDown="MM_openBrWindow('./pages/gdpr.html','','scrollbars=yes,width=550,height=250')" title="Click this link to go to our privacy policy" alt="Click this link to go to our privacy policy">privacy policy</a>.
                            <input type="checkbox" id="confirm" name="confirm" value="Confirmed Consent" required oninvalid="this.setCustomValidity('Have you read my privacy policy? It won\'t take long :)')" oninput="this.setCustomValidity('')"  placeholder="Click Consent" tabindex="52"  />
        ...
        <article id="dyspraxia" tabindex="54">
