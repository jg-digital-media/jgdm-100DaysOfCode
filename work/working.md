...
In order to return something, I knew I needed a variablebut I've also defined a parameter to the method which I then realised I didn't need.  I'm not aware of a function at this point that counts words in a string so I just hard coded the value myself.
...
This one, a real struggle.  I've tried every method I can think of to get the correct referene to the function return value and call it on the method but it's lost on me now.
